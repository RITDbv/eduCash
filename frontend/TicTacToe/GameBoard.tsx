    ...
    <View style={styles.container}>
      {playerSymbol === '' && (
        <View style={styles.symbolSelection}>
          <TouchableOpacity style={styles.symbolButton} onPress={() => chooseSymbol('X')}>
            <Text style={styles.symbolButtonText}>Play as X</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.symbolButton} onPress={() => chooseSymbol('O')}>
          ...
          <View style={styles.playerInfoContainer}>
            <View style={styles.playerInfo}>
              ...
              <View style={styles.playerDetails}>
                ...
                <Text style={styles.playerDetailsText}>{`You are ${playerSymbol}`}</Text>
              </View>
            </View>
            ...
            <View style={styles.opponentInfo}>
              <View style={styles.playerDetails}>
                ...
                <Text style={styles.playerDetailsText}>{`Opponent is ${computerSymbol}`}</Text>
              </View>
              <View style={styles.playerAvatar}>
                <Image
                  source={{ uri: 'https://cdn-icons-png.flaticon.com/512/166/166344.png' }} // Replace with your opponent's avatar image URL
                  style={styles.avatarImage}
                />
              </View>
            </View>
          </View>
          <Text style={styles.title}>{winner ? `Winner: ${winner}` : isPlayerTurn ? 'Your Turn' : 'Opponent\'s Turn'}</Text>
